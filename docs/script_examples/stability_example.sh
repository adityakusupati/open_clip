...
cd /fsx/home-kusupati/open_clip/src
export PYTHONPATH="$PYTHONPATH:/fsx/home-kusupati/open_clip/src"

EXP_NAME="test-B-32-laion5b-lr1e-3-bs90k-mrl"
...
srun --comment laion --cpu_bind=v --accel-bind=gn python -m training.main \
    ...
    --wandb-project-name open_clip_mrl \
    --resume "latest" \
    --remote-sync s3://s-laion/home-kusupati/logs